...
interface FriendExperiencesSectionClientProps {
  items: ContentItem[];
}

export default function FriendExperiencesSectionClient({ items }: FriendExperiencesSectionClientProps) {
